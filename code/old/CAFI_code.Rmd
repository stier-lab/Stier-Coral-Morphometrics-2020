...
coral_pg <- read.csv(here("morphometric_data/old/photogrammetry_data.csv")) 
coral_field <- read.csv(here("morphometric_data/field_experiment_colony_measurements_moorea_summer2019.csv"))
cafi_surveys <- read.csv(here("cafi_data/old/revised_cafi_data_moorea_summer2019_11_27.csv"))
cafi_field <- read.csv(here("cafi_data/old/prelim_cafi_counts_moorea_summer2019.csv"))
...
ggsave("fig1.pdf", plot = fig1, path="figures", width=7, height=4)
```
...
ggsave("fig2.pdf", plot = fig2, path="figures", width=5, height=4)
...
ggsave("fig3.pdf", plot = fig3, path="figures", width=6, height=4)
```
...
ggsave("fig4.pdf", plot = fig4, path="figures", width=6, height=4)
```
...
ggsave("fig5.pdf", plot = fig5, path="figures", width=5, height=4)
```
