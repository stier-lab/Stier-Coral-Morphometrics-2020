...
manual_dec_trim <- december_manual %>% select(coral_id, volume = volume_est_dec, growth = vol_growth_man, prop_growth = prop_growth_man) %>% mutate(method = "Ellipse")

photo_dec_trim <- december_photo %>% select(coral_id, volume = volume_pg, growth = vol_growth_pg, prop_growth = prop_growth_pg) %>% mutate(method = "Photo")
...
ggMarginal(growth_scatter, type = "density", fill = "coral", color = "lightslategray")
ggMarginal(prop_growth_scatter, type = "density", fill = "coral", color = "lightslategray")
