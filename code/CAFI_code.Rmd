...
volume <- ggplot(dim_bind, aes(x=volume_pg, y=volume_field))+ 
  ...
  geom_abline(intercept = 611.4145, slope = 1, color='blue') #x-intercept pulled from summary data
...
height <- ggplot(dim_bind, aes(x=height_pg, y=height_field))+ 
  ...
  geom_abline(intercept = 2.44284, slope = 1, color='blue') 
...
length <- ggplot(dim_bind, aes(x=length_pg, y=length_field))+ 
  ...
  geom_abline(intercept = 0.52596, slope = 1, color='blue')
...
width <- ggplot(dim_bind, aes(x=width_pg, y=width_field))+ 
  ...
  geom_abline(intercept = 2.13398, slope = 1, color='blue')
