...
# Summary Stats - Number of photos
...
# Ellipsoid - Skeleton vs skeletal volume LM

lm_diff_vs_vol <- lm(diff_est ~ volume_pg, data = coral_dim)
summary(lm_diff_vs_vol)

# Ellipsoid - Skeleton Prop vs skeletal volume LM
...
# Pairwise T-test: Volume and proportional growth manual vs. photo - Fig1
...
# November 2022 additions - Photogrammetric ellipsoid
