...
plot(num_cafi~volume_pg, data = cafi_coralwide,
    xlab = "Coral volume m^(3)", ylab = "CAFI abundance", main = "Wide coral volume and invert abundance")
# Overlay best fit line on existing plot
...
plot(num_cafi~volume_pg, data = cafi_coraltight,
    xlab = "Coral volume m^(3)", ylab = "CAFI abundance", main = "Tight coral volume and invert abundance")
# Overlay best fit line on existing plot
